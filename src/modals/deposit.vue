<template>
  <modal class="deposit-modal" :title="`Deposit ${name} Tokens`" :acceptText="!loading ? 'Confirm' : 'Pending Confirmation'" cancelText="Cancel" :accept="onAccept" :acceptDisabled="loading">
    <div class="main">
